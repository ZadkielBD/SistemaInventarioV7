...
namespace SistemaInventarioZ.Areas.Inventario.Controllers
{
    ...
    public class InventarioController : Controller
    {
        ...
        public IActionResult NuevoInventario() 
        {
            ...
            //Obtener el Id del Ussuario desde la sesion
        ...
        public async Task<IActionResult> GenerarStock(int itemid)
        {
            var inventario = await _unidadTrabajo.Inventario.Obtener(itemid);
            var detalleLista = await _unidadTrabajo.InventarioDetalle.ObtenerTodos(d =>d.InventarioId == itemid);
            //Obtener el Id del Ussuario desde la sesion
            var claimIdentity = (ClaimsIdentity)User.Identity;
            var claim = claimIdentity.FindFirst(ClaimTypes.NameIdentifier);
        ...
        { 
            ...
            kardexInventarioVM.FechaInicial = DateTime.Parse(fechaInicioId);
            ...
            kardexInventarioVM.KardexInventarioLista = await _unidadTrabajo.KardexInventario.ObtenerTodos(
                                                                k => k.BodegaProducto.ProductoId == productoId &&
                                                                    (k.FechaRegistro >= kardexInventarioVM.FechaInicial &&
        ...
        public async Task<IActionResult> ImprimirKardex(string fechaInicio, string fechaFinal, int productoId)
        {
            ...
            kardexInventarioVM.FechaInicial = DateTime.Parse(fechaInicio);
